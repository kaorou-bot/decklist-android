...
#### 已完成 ✅ (2026-02-16)
- [x] API 接口层更新
  - MtgchApi.kt - 更新为自有服务端端点
  - 移除 MTGCH 特有参数
  - 添加完整的 API 文档注释
- [x] 数据模型更新
  - MtgchSearchResponse - 适配自有服务端响应格式
  - 添加 success 字段检查
- [x] 依赖注入配置更新
  - AppModule.kt - 确认 Base URL 配置
- [x] ViewModel 层更新
  - SearchViewModel.kt - 更新搜索方法
  - 移除 MTGCH 特有参数
  - 添加 success 字段检查
- [x] 配置文件更新
  - 创建 MtgCardServerConfig.kt
  - 更新 build.gradle
- [x] 迁移文档
  - 创建 SelfHosted_API_Migration_Report.md

**API 服务器**: http://182.92.109.160/
