...
class MainActivity : AppCompatActivity() {
    ...
    private fun showScrapingOptionsDialog() {
        ...
        val builder = android.app.AlertDialog.Builder(this)
            .setTitle("Scrape MTGO Decklists from Magic.gg")
            .setMessage("Select format and date to scrape all matching decklists.\n\n• Format: Tournament format\n• Date: Specific event date\n\nAll available decklists for the selected criteria will be downloaded.")
        ...
        builder.setPositiveButton("Start Scraping") { dialog, _ ->
            ...
            startScraping(format, selectedDate)
            dialog.dismiss()
        }
        .setNegativeButton("Cancel", null)
